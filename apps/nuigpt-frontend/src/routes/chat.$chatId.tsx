...
//       }
//       console.log(
//         "All deletes done, remaining messages:",
//         msgs.slice(0, editedIdx + 1).length,
//       );
...
//         .ca-msg-user { display: flex; justify-content: flex-end; width: 100%; }
// .ca-bubble-user {
//   background: #f4f4f4;
//   color: #0d0d0d;
//   padding: 12px 18px;
...
//                 <button
//                   className="ca-img-preview-remove"
